...
(async () => {
  ...
  const htmlPath = path.resolve(__dirname, 'meal-plan.html');
  await page.goto(`file://${htmlPath}`, { waitUntil: 'networkidle0' });
  await page.pdf({
    path: path.resolve(__dirname, 'output/with-the-flow.pdf'),
    width: '6in',
    height: '9in',
  ...
  await browser.close();
  console.log('PDF generated: output/with-the-flow.pdf');
})();
